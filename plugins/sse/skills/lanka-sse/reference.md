...
> **`@lankajs/plugin-sse@5.0.0`** — this document describes that version.
>
...
[`@lankajs/plugin-websocket`](https://github.com/lankajs/lanka/blob/main/plugins/websocket/GUIDE.md) ships a transport behind the
same port:
...
[`lanka/stream`](https://github.com/lankajs/lanka/blob/main/core/GUIDE.md#streams--a-change-that-arrives-from-the-server)
