...
> **`@lankajs/plugin-bootstrap-steps@4.0.0`** — this document describes that version.
>
...
Maintaining this package: [SKILL.md](https://github.com/lankajs/lanka/blob/main/plugins/bootstrap-steps/SKILL.md) · What it is:
[README.md](https://github.com/lankajs/lanka/blob/main/plugins/bootstrap-steps/README.md) · Core's bootstrap:
