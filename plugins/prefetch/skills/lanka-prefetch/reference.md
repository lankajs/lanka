...
> **`@lankajs/plugin-prefetch@1.0.1`** — this document describes that version.
>
...
Maintaining this package: [SKILL.md](https://github.com/lankajs/lanka/blob/main/plugins/prefetch/SKILL.md) · What it is:
[README.md](https://github.com/lankajs/lanka/blob/main/plugins/prefetch/README.md) · Repository map: [../../README.md](https://github.com/lankajs/lanka/blob/main/README.md)
