...
export const PACKAGES = [
	// ─────────────────────────────────────────────────────────── CORE ──
	{
		...
		short: "lanka",
		title: "Core",
		gist: "Ten subsystems, two peer dependencies, five extension points.",
	...
	// ──────────────────────────────────────────────────────── PLUGINS ──
	{
		...
		gist: "Retry, idempotency, CSRF, auth refresh and timeout as transport middleware.",
		runtime: ["browser", "node", "native"],
		hasTests: true,
		devDeps: { "@lankajs/tool-testing": "workspace:^" },
	...
	},
	{
		...
		devDeps: { "@lankajs/tool-testing": "workspace:^" },
		socket: "LankaLogger sinks · lankaEventBus.addMiddleware",
		notes: [
