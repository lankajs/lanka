...
> **`@lankajs/nanostores-query@1.0.0`** — this document describes that version.
>
> Install: `npm install @lankajs/nanostores-query @nanostores/query nanostores zustand` (the peers are not optional; only npm adds a missing one for you).
>
