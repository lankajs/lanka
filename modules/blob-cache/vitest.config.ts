...
/**
 * The cache talks almost entirely to browser APIs — IndexedDB, Cache Storage,
 * object-URL, `pagehide` — so the whole package runs under jsdom.
 */
export default defineConfig({
	resolve: { alias: lankaDiAlias() },
	test: {
		/*
		 * Measured twice: 91.53 / 89.76 / 83.87 / 91.53 and 91.53 / 89.80 / 83.87 / 91.53
