...
import { createPlaygroundFormikOptions } from "../create-playground-formik-options/createPlaygroundFormikOptions";
import { readPlaygroundFormikMessage } from "../read-playground-formik-message/readPlaygroundFormikMessage";
...
export const PlaygroundFormikScreen = (props: IPlaygroundFormScreenProps) => {
	...
	const messageAt = (address: string) => readPlaygroundFormikMessage(formik.errors, address);
