...
> **`@lankajs/mmkv@1.0.1`** — this document describes that version.
>
> Install: `npm install @lankajs/mmkv react-native-mmkv zustand` (the peers are not optional; only npm adds a missing one for you).
>
...
Maintaining this package: [SKILL.md](https://github.com/lankajs/lanka/blob/main/modules/storage-adapters/mmkv/SKILL.md) · What it is:
[README.md](https://github.com/lankajs/lanka/blob/main/modules/storage-adapters/mmkv/README.md) · Repository map: [../../../README.md](https://github.com/lankajs/lanka/blob/main/README.md)
