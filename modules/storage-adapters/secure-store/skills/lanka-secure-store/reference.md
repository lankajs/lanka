...
> **`@lankajs/secure-store@0.0.0`** — this document describes that version.
>
> Install: `npm install @lankajs/secure-store expo-secure-store react zustand` (the peers are not optional; only npm adds a missing one for you).
>
