...
> **`@lankajs/storage@2.1.0`** — this document describes that version.
>
> Install: `npm install @lankajs/storage zustand` (the peers are not optional; only npm adds a missing one for you).
>
...
Maintaining this package: [SKILL.md](https://github.com/lankajs/lanka/blob/main/modules/storage/SKILL.md) · What it is:
[README.md](https://github.com/lankajs/lanka/blob/main/modules/storage/README.md) · Repository map: [../../README.md](https://github.com/lankajs/lanka/blob/main/README.md)
