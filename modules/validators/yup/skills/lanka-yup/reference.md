...
> **`@lankajs/yup@1.0.1`** — this document describes that version.
>
> Install: `npm install @lankajs/yup yup zustand` (the peers are not optional; only npm adds a missing one for you).
>
