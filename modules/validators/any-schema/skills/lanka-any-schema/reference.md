...
> **`@lankajs/any-schema@1.1.0`** — this document describes that version.
>
> Install: `npm install @lankajs/any-schema zustand` (the peers are not optional; only npm adds a missing one for you).
>
