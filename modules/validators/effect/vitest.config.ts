...
export default defineConfig({
	...
	test: {
		/*
		 * Measured twice: 99 / 99 / 99 / 99
		 * (statements / branches / functions / lines).
		 *
		 * The package is a cache and two delegations, so the number is easy to hold —
		 * and anything that makes it hard to hold is probably code that belongs in
		 * core or in the application's own Effect runtime.
		 *
