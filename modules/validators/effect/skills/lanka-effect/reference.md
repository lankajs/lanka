<!-- Generated from modules/validators/effect/GUIDE.md by scripts/skills.mjs. Edit the guide. -->

> **`@lankajs/effect@0.0.0`** — this document describes that version.
>
> Install: `npm install @lankajs/effect effect react zustand` (the peers are not optional; only npm adds a missing one for you).
>
> Complete code, compiled and run in CI: [modules/validators/effect/_playground/playground.test.ts](https://github.com/lankajs/lanka/blob/main/modules/validators/effect/_playground/playground.test.ts)
...
Maintaining this package: [SKILL.md](https://github.com/lankajs/lanka/blob/main/modules/validators/effect/SKILL.md) · What it is:
[README.md](https://github.com/lankajs/lanka/blob/main/modules/validators/effect/README.md) · Repository map: [../../../README.md](https://github.com/lankajs/lanka/blob/main/README.md)
