...
Coverage is a ratchet: statements 99, branches 99, functions 99, lines 99 — raised
from 92/83/99/92 when the foreign-schema guard and the zod 3 strict path gained
tests. A ratchet only tightens.
