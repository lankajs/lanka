<!-- Generated from modules/validators/valibot/GUIDE.md by scripts/skills.mjs. Edit the guide. -->

> **`@lankajs/valibot@1.0.1`** — this document describes that version.
>
> Install: `npm install @lankajs/valibot valibot zustand` (the peers are not optional; only npm adds a missing one for you).
>
> Complete code, compiled and run in CI: [modules/validators/valibot/_playground/playground.test.ts](https://github.com/lankajs/lanka/blob/main/modules/validators/valibot/_playground/playground.test.ts)
...
[`@lankajs/zod`](https://github.com/lankajs/lanka/blob/main/modules/validators/zod/GUIDE.md) — or neither, and its dependency list then shows
...
Maintaining this package: [SKILL.md](https://github.com/lankajs/lanka/blob/main/modules/validators/valibot/SKILL.md) · What it is:
[README.md](https://github.com/lankajs/lanka/blob/main/modules/validators/valibot/README.md) · Repository map: [../../../README.md](https://github.com/lankajs/lanka/blob/main/README.md)
