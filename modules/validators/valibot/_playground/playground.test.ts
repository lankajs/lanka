 ...
 *
 * What matters is not that valibot validates — valibot's own tests cover that — but
 * that a valibot schema passes through the framework's validator port intact, and
 * that a failure arrives as something a form can put next to an input.
 *
