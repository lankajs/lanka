...
export const PLAYGROUNDS = [
	...
	},
	{
		...
		ecosystem: null,
		suites: [],
		why: "The Angular binding against Angular 21 and Angular Testing Library 18: every scene the binding is held to, after asserting the major it resolved. The evidence behind the ^21 in its peer range.",
	},
	{
		dir: "_playgrounds/versions/angular-22",
		contract: "NONE",
		ecosystem: null,
		suites: [],
		why: "The Angular binding against Angular 22 and Angular Testing Library 19: every scene the binding is held to, after asserting the major it resolved. The evidence behind the ^22 in its peer range.",
	},
	{
		dir: "_playgrounds/versions/vitest-4",
		contract: "NONE",
		ecosystem: null,
		suites: [],
		why: "The test kit under Vitest 4 — its setup file, its helpers and a conformance suite registering into the running Vitest — after asserting the running major. The evidence behind the ^4 in its peer range.",
	},
	{
		dir: "_playgrounds/versions/vitest-5",
		contract: "NONE",
		ecosystem: null,
		suites: [],
		why: "The test kit under Vitest 5, and a real Vite 8 build through tool-di's adapter, each after asserting the major it runs. The evidence behind the ^5 and the vite ^8 in the two peer ranges.",
	},
	{
