 ...
 * are the same plugins, the gateways are the same gateways, and nothing in this
 * file mentions Vue. That is the claim the whole of `_plans/14` was written to
 * make, and a start-up file is where it is easiest to check — because if the
 * framework knew which renderer it was under, this is where it would show.
 */
