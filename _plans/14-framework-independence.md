...
Осталось: семь приложений-плейграундов (`vue`, `nuxt`, `svelte`, `sveltekit`,
`solid`, `solid-start`, `angular`), острова Astro на нескольких фреймворках,
...
**Привязка сделана 2026-09-15; приложения — нет.** Vue нашёл три дефекта, ни
