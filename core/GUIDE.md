...
[`@lankajs/plugin-http`](../plugins/http/GUIDE.md) already has all four.
...
[`@lankajs/plugin-websocket`](../plugins/websocket/GUIDE.md),
[`@lankajs/plugin-graphql`](../plugins/graphql/GUIDE.md),
[`@lankajs/plugin-grpc`](../plugins/grpc/GUIDE.md) — each of which is one
