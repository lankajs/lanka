...
in all thirty-nine packages. Copying a skill into each README would create
thirty-nine copies, thirty-eight of which eventually drift.
...
true of: **all thirty-nine, and it lives here; one, and it lives there.** A rule
